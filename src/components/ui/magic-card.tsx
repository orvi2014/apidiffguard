...
export function MagicCard(props: MagicCardProps) {
  ...
  // The app is dark-only. This previously read next-themes without a provider
  // anywhere in the tree, so it resolved to `undefined` and flipped to the
  // light-mode gradient one render after mount.
