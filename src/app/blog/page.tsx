...
export const metadata: Metadata = buildMetadata({
  title: "Blog — API Monitoring, JSON Diffs & CI Gates",
  description:
    "Guides on detecting breaking API changes, monitoring third-party APIs like Stripe, and shipping safer integrations with schema drift checks.",
  path: "/blog",
});
